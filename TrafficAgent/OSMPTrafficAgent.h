/*
 * Adapted for FZIDriver: Markus Lemmer
 * Author of OSMPTrafficAgent: Daniel Becker
 * Based on: PMSF FMU Framework for FMI 2.0 Co-Simulation FMUs
 *
 * (C) 2019 Institute for Automotive Engineering, RWTH Aachen Univ.
 * (c) 2021 FZI Research Center for Information Technology
 *
...
#if TARGET_OPEN_PASS
#define FMI_INTEGER_SENSORVIEW_CONFIG_REQUEST_BASELO_IDX 9
#define FMI_INTEGER_SENSORVIEW_CONFIG_REQUEST_BASEHI_IDX 10
#define FMI_INTEGER_SENSORVIEW_CONFIG_REQUEST_SIZE_IDX 11
#define FMI_INTEGER_SENSORVIEW_CONFIG_BASELO_IDX 12
#define FMI_INTEGER_SENSORVIEW_CONFIG_BASEHI_IDX 13
#define FMI_INTEGER_SENSORVIEW_CONFIG_SIZE_IDX 14
#endif
...
class COSMPTrafficAgent {
    ...
    std::shared_ptr<FZIDriver::TrafficAgent> agentModel;
